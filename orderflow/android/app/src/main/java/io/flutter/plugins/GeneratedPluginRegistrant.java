...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.shariar99.screen_secure.ScreenSecurePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin screen_secure, com.shariar99.screen_secure.ScreenSecurePlugin", e);
    }
    try {
